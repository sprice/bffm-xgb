  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="pt-2 pb-4">
        <h2 className="font-display text-6xl max-sm:text-4xl font-semibold leading-tight text-text tracking-tight text-center mb-5 animate-in">
          Discover your personality
          <br />
          <span className="text-text-muted">in under 3 minutes</span>
        </h2>

        <p className="text-base text-text-muted tracking-wide uppercase font-medium text-center mb-8 animate-in stagger-1">
