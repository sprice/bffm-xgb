...
export const chapter01Orientation: Chapter = {
  ...
  content: `
    ${section(
      ...
      `
        ${lead(
          `This repository is a ${abbr("research pipeline", "A staged, reproducible workflow for turning data into results and artifacts.")} and ${abbr("runtime product", "The packaged system that is actually used after training, rather than the training code itself.")} for predicting ${abbr("Big Five personality scores", "Scores for the five broad personality domains: Extraversion, Agreeableness, Conscientiousness, Emotional Stability, and Intellect or Openness.")} from partial answers to the 50-item ${abbr("IPIP-BFFM inventory", "The IPIP Big Five Factor Markers questionnaire: a public-domain 50-item Big Five personality measure.")}; it isn't a generic ${abbr("machine-learning", "A field of computing where models learn patterns from data to make predictions.")} demo.`,
        )}
        ${paragraph(
